      ...
      new workbox.rangeRequests.RangeRequestsPlugin(),
      {
        async fetchDidSucceed({ request, response }) {
          if (
            ...
            response = await workbox.rangeRequests.createPartialResponse(
              request,
              response
            )
          }
